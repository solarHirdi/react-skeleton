import Gallery from '../../api/Account.js';

export const types = {
    GET_PHOTOS_REQUEST: Symbol('GET_PHOTOS_REQUEST'),
	GET_PHOTOS_SUCCESS: Symbol('GET_PHOTOS_SUCCESS'),
	GET_PHOTOS_FAIL: Symbol('GET_PHOTOS_FAIL')
};
